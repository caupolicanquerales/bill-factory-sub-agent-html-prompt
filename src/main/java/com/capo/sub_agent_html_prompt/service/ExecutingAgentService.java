package com.capo.sub_agent_html_prompt.service;
...
import com.capo.sub_agent_html_prompt.request.GenerationSyntheticDataRequest;
import com.capo.sub_agent_html_prompt.response.DataMessage;
import com.capo.sub_agent_html_prompt.utils.ConverterUtil;
...
public class ExecutingAgentService {
	...
	public ExecutingAgentService(@Qualifier("chatClientConverter") ChatClient chatClient,
